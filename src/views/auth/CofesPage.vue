...
const images = [
  {
    src: 'public/84eb32d90ac21ba8a833917517797dcf.jpg',
    price: '₱300',
    name: 'College Tee',
  },
  {
    src: 'public/d017ef26614df270ddfd46ab8decd0b9.jpg',
    price: '₱500',
    name: 'Outfits',
  },
  {
    src: 'public/97d4481509af8e5c575f22afe45a927d.jpg',
    price: '₱150',
    name: 'Accessories',
  },
  {
    src: 'public/77558b8324e28ff98123055f5c206f79.jpg',
    price: '₱100',
    name: 'Lanyard',
  },
]
    ...
    <template #content>
      <v-responsive class="border rounded">
        <v-app
          :theme="theme"
          style="
            background: linear-gradient(to left, #e1ebdc, #a9c6a9);
        ...
        >
          ...
          <v-main>
            <v-container fluid>
              <v-img
                src="public/pexels-ivan-drazic-20457695-20385805.jpg"
                height="400px"
                cover
              >
                <div class="b-text">
              ...
              <v-container class="text-center mt-8">
                ...
                >
                  "Represent your love for forests and the earth with our
                  eco-inspired merch."
                </h1>
                <p
                  class="text-body-1"
                  ...
                  "
                >
                  "Celebrate your passion for the natural world with gear made
                  for you."
                </p>
              </v-container>
