...
>
      ...
      <!-- App Bar -->
      <v-app-bar :style="{ background: 'linear-gradient(to right, #8B0000, #FF0000)' }" class="px-3 nav-bar">
      ...
      <v-main>
        <v-container fluid>
          <v-img src="public/pexels-karinarud-11964281.jpg" height="400px" cover></v-img>
